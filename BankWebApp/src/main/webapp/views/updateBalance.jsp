...
<body>
	...
	<div class="container">
		...
		<form action="<%= request.getContextPath() %>/updateBalance"
			method="post">
			...
			<div class="mb-3">
				<label for="accountNumber" class="form-label">Account
					...
					name="accountNumber" value="<%= customer.getAccountNumber() %>"
					readonly />
			</div>

			<!-- Amount to Add or Withdraw -->
			<div class="mb-3">
				<label for="amount" class="form-label">Amount to
					Add/Withdraw:</label> <input type="number" class="form-control" id="amount"
