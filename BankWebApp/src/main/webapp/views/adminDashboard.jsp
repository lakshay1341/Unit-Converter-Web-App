<%@ page contentType="text/html;charset=UTF-8" language="java" import="java.util.List" import="com.bank.dto.TransactionDTO" import="com.bank.dto.ComplaintDTO" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container dashboard-container">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <h2>Welcome, Admin</h2>
                <p class="mb-4">Manage transactions, complaints, and users from this dashboard.</p>
                <div class="d-grid gap-2">
                    <a href="/BankWebApp/transactionList" class="btn-custom">View All Transactions</a>
                    <a href="/BankWebApp/complaintList" class="btn-custom">View Complaints</a>
                    <a href="/BankWebApp/viewAllCustomers" class="btn-custom">Manage Users</a>
                    <a href="/BankWebApp/logout" class="btn-custom">Logout</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                Transaction ID: <%= transaction.getTransactionId() %> | Amount: <%= transaction.getRemarks() %> | Date: <%= transaction.getTransactionDate() %>
                            </li>
                            <% 
                                    }
                                } else { 
                            %>
                            <li class="list-group-item">No recent transactions available.</li>
                            <% } %>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            %>
                            <li class="list-group-item">
                                Complaint ID: <%= complaint.getComplaintNo() %> | Subject: <%= complaint.getSubject() %> | Date: <%= complaint.getComplaintDate() %>
                            </li>
                            <% 
                                    }
                                } else { 
