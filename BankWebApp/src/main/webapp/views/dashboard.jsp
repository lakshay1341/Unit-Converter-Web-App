            ...
            <div class="card-body">
                ...
                <div class="account-info">
                    ...
                    <div>
                        ...
                        <p class="info-value">₹ <%= customer.getBalance() %></p>
                    </div>
                </div>
                ...
                <div class="action-btns">
                    <a href="updateBalance">Add/Withdraw Balance</a>
                    <a href="transferMoney">Transfer Money</a>
                    <a href="complaintHistory">View Complaint History</a>
                    <a href="transactionHistory">View Transaction History</a>
                    <a href="updateCustomerInfo">Update Personal Information</a>
