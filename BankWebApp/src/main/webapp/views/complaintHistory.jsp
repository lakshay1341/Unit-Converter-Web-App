<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.util.List" import="com.bank.dto.ComplaintDTO"%>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body bg-light">
                ...
                <a href="addComplaint" class="btn btn-primary mb-3">Add New Complaint</a>
                <hr>
