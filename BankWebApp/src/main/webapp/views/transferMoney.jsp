...
<body>
    ...
    <div class="container">
        ...
        <form action="<%= request.getContextPath() %>/transferMoney" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="senderAccount" name="senderAccount" value="<%= ((CustomerDTO) session.getAttribute("customer")).getAccountNumber() %>" readonly/>
            </div>
