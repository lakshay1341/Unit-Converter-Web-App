...
<body>
    ...
    <div class="container">
        ...
        <!-- Update Form -->
        <form action="<%= request.getContextPath() %>/updateCustomerInfo" method="post">
            <!-- First Name -->
            <div class="mb-3">
                <label for="fname" class="form-label">First Name:</label>
                <input type="text" class="form-control" id="fname" name="fname" value="<%= customer.getFname() %>" required>
            </div>

            <!-- Last Name -->
            <div class="mb-3">
                <label for="lname" class="form-label">Last Name:</label>
                <input type="text" class="form-control" id="lname" name="lname" value="<%= customer.getLname() %>" required>
            </div>
